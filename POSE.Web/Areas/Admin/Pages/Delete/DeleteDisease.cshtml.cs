namespace POSE.Web.Areas.Admin.Pages.Delete
{
    ...
    /// <summary>
    /// Defines the <see cref="DeleteDiseaseModel" />
    /// </summary>
    public class DeleteDiseaseModel : PageModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteDiseaseModel"/> class.
        /// </summary>
        ...
        public DeleteDiseaseModel(IAdminCreateServices adminCreateServices, IExaminationServices examinationServices)
        {
        ...
        public IActionResult OnGet(string returnUrl = null)
        {
            ...
            ViewData["Diseases"] = this._examinationServices.ReturnAllDiseaseNames();
            ReturnUrl = returnUrl;
            return Page();
        }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var result = await this._adminCreateServices.DeleteDiseaseAsync(Input.Name);
            if (result > 0)
            {
            ...
            if (result == -1)
            {
                return NotFound($"Unable to delete disease with name '{Input.Name}', a disease with that name does not exist.");
            }
            else return Page();
        }
    }
