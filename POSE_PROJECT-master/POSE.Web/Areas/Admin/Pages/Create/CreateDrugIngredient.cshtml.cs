namespace POSE.Web.Areas.Admin.Pages.Create
{
    ...
    /// <summary>
    /// Defines the <see cref="CreateDrugIngredientModel" />
    /// </summary>
    public class CreateDrugIngredientModel : PageModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDrugIngredientModel"/> class.
        /// </summary>
        /// <param name="adminCreateServices">The adminCreateServices<see cref="IAdminCreateServices"/></param>
        public CreateDrugIngredientModel(IAdminCreateServices adminCreateServices)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            var result = await this._adminCreateServices.CreateDrugIngredientAsync(dto);
            if (result > 0)
            {
            ...
            if (result == -1)
            {
                return NotFound($"Unable to create drug ingredient with name '{dto.Name}', an ingredient with this name is already created.");
            }
            else return Page();
        }
    }
